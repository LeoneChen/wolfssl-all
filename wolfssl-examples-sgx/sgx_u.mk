...
$(UNTRUSTED_DIR)/Wolfssl_Enclave_u.c: $(SGX_EDGER8R) trusted/Wolfssl_Enclave.edl
	@cd $(UNTRUSTED_DIR) && $(SGX_EDGER8R) --untrusted ../trusted/Wolfssl_Enclave.edl --search-path ../trusted --search-path $(SGX_SDK)/include --search-path $(SGXSanPath)/SGXSanRT/SGXSanRTEnclave
	@echo "GEN  =>  $@"
...
App: $(UNTRUSTED_DIR)/Wolfssl_Enclave_u.o $(App_C_Objects) $(LibSGXSanRTApp)
	@$(CXX) $(filter-out $(LibSGXSanRTApp), $^) -o $@ $(SGXSanRTApp_Link_Flags) $(App_Link_Flags) -Wl,-rpath=$(SGXSanPath)/PSWPatches/enclave_common_patch
	@echo "LINK =>  $@"
